...
<template>
  <section class="relative flex h-screen w-5/6 items-center self-end bg-[#967259] px-10">
    <!--#region spirals -->
    <!-- first sprial -->
    <img
    ...
    <img
      ...
      class="absolute top-2 -left-6 z-10 w-6"
    ...
    <img
      v-if="scrollPercent === 0"
      class="absolute -left-6 z-10 mb-4 w-6"
      src="@/assets/images/spiral-holes.png"
      alt="spiral-holes"
      draggable="false"
    />
    ...
    <img
      v-if="scrollPercent === 0"
      class="absolute bottom-5 -left-6 z-10 w-6"
      src="@/assets/images/spiral-holes.png"
      alt="spiral-holes"
      draggable="false"
    />
